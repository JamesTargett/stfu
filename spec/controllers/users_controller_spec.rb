...
describe UsersController do
  ...
  describe "POST 'create'" do
    it "creates a new user with all correct info" do
      ...
      post :create, user: {username: "Tyler Durden", email: "tylerd@makeandsellsoap.com", password: "hitmeashardasyoucan", password_confirmation: "hitmeashardasyoucan"}
    ...
    it "fails to create a user with missing information" do
      # FIXME: Use FactoryGirl to generate the params 
      post :create, user: {username: "Tyler Durden", password: "hitmeashardasyoucan", password_confirmation: "hitmeashardasyoucan"}
      user = assigns(:user) # fetches @user
